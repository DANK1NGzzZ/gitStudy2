...
@Controller
public class YwhUserController {
...
/**
    ...
    public String register(Sys_user sys_user) {
        int isSuccess = ywhUserService.register(sys_user);
 ...
 @RequestMapping( "/login")
     public String login(String username,String password) {
         ...
         List<Sys_user> sys_user = ywhUserService.login(username, password);
